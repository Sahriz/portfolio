...
The project uses the **HagRID (Hand Gesture Recognition Image Dataset)** for training, along with a self-collected dataset of eleven distinct gestures captured directly via webcam. The data is preprocessed and organized into labeled gesture classes stored in:
```
